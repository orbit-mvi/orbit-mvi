...
@Suppress("unused")
class NamedContainerHost : ContainerHost<State, Int>, TestContainerHost {
    override val container =
        CoroutineScope(Dispatchers.Unconfined).container<State, Int>(State.Loading, containerHostName = "CustomContainerHostName")
