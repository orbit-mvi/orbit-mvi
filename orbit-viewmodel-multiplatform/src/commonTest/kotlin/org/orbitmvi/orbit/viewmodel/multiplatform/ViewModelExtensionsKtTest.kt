...
package org.orbitmvi.orbit.viewmodel.multiplatform
...
class ViewModelExtensionsKtTest : RobolectricTest() {
    ...
    fun modified_state_is_saved_in_the_saved_state_handle_for_state_flow() = runTest {
        ...
        middleware.container.stateFlow.test {
            ...
            assertEquals(TestState(something), savedStateHandle.get<SavedState>(SAVED_STATE_KEY)?.toTestState())
        }
    }
    ...
    private fun SavedState.toTestState(): TestState = decodeFromSavedState(TestState.serializer(), this)
}
