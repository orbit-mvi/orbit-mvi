...
public data class TestSettings(
    /**
     * Set this to override the [OrbitContainer]'s [CoroutineDispatcher]s for this test
     */
    val dispatcherOverride: CoroutineDispatcher? = null,

    /**
     * Set this to override the [OrbitContainer]'s [CoroutineExceptionHandler]s for this test
     */
